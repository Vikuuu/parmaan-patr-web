...
func (app *application) readJSON(w http.ResponseWriter, r *http.Request, dst any) error {
	...
	// Initialize the json.Decoder, and DisallowUnknownFields() method on it
	...
	err := dec.Decode(dst)
	if err != nil {
		// It there is an error during decoding, start the triage...
		...
		// field "<name>"`. We check for this, extract the field name from the err,
		// and interpolate it into out custom error message. Note that there's an open
	...
	// destination. If the request body contained a single JSON value this will
